...
source ~/.config/fish/custom/yazi.fish
source ~/.config/fish/custom/nvim-custom.fish
...
if [ -f '/home/20104519/google-cloud-sdk/path.fish.inc' ]
    . '/home/20104519/google-cloud-sdk/path.fish.inc'
end
